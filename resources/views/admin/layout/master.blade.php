...
<head>
    ...
    <link href="./admin/css/my_style.css" rel="stylesheet">
                                ...
                                <div class="dropdown-menu-header">
                                    <div class="dropdown-menu-header-inner bg-secondary">
                                        <div class="menu-header-image opacity-5"
                                            style="background-image: url('./admin/assets/images/dropdown-header/abstract2.jpg');">
                                        </div>
                                ...
                                <div class="dropdown-menu-header">
                                    <div class="dropdown-menu-header-inner bg-success">
                                        <div class="menu-header-image opacity-1"
                                            style="background-image: url('./admin/assets/images/dropdown-header/abstract3.jpg');">
                                        </div>
                                                        ...
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                ...
                                                                <div class="widget-content-right mr-2">
                                                                    <button
                                                                        class="btn-pill btn-shadow btn-shine btn btn-focus"> <a href="{{ Route('logout') }}" style="text-decoration: none; color: inherit;">Logout</a></button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
