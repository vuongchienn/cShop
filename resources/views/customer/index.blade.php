            ...
            <div class= "row">
                ...
                <div class = "col-lg-8 offset-lg-1">
                    ...
                    <div class="product-slider owl-carousel">
                        <div class= "product-item">
                            <div class= "pi-pic">
                                ...
                                <ul>
                                    ...
                                    <li class= "quick-view"><a href= "#" class="">Quick View</a></li>
                        ...
                        <div class= "product-item">
                            <div class= "pi-pic">
                                <img src=  "customer/img/products/women-2.jpg" alt = "">
                                <div class=  "sale">
                                    Sale
                                </div>
                                <div class= "icon">
                        ...
                        <div class= "product-item">
                            <div class= "pi-pic">
                                <img src=  "customer/img/products/women-3.jpg" alt = "">
                                <div class=  "sale">
                                    Sale
                                </div>
                                <div class= "icon">
                        ...
                        <div class= "product-item">
                            <div class= "pi-pic">
                                <img src=  "customer/img/products/women-4.jpg" alt = "">
                                <div class=  "sale">
                                    Sale
                                </div>
                                <div class= "icon">
            ...
            <div class= "row">
                ...
                <div class = "col-lg-8">
                    ...
                    <div class="product-slider owl-carousel">
                        ...
                        <div class= "product-item">
                            <div class= "pi-pic">
                                <img src=  "customer/img/products/man-2.jpg" alt = "">
                                <div class=  "sale">
                                    Sale
                                </div>
                                <div class= "icon">
                        ...
                        <div class= "product-item">
                            <div class= "pi-pic">
                                <img src=  "customer/img/products/man-3.jpg" alt = "">
                                <div class=  "sale">
                                    Sale
                                </div>
                                <div class= "icon">
                        ...
                        <div class= "product-item">
                            <div class= "pi-pic">
                                <img src=  "customer/img/products/man-4.jpg" alt = "">
                                <div class=  "sale">
                                    Sale
                                </div>
                                <div class= "icon">
